...
//
// Copied verbatim from the `time` repo (functions/api/_lib/crypto.ts), which
// took it from make/bloodbowl. It is in production on both. Do not "improve"
// it — any change here needs the same scrutiny the original got.
